...
<body>
    <header>
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid ">
                <a class="navbar-brand mx-3" href="<?php echo e(route('user_dashboard')); ?>"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="<?php echo e(route('user_dashboard')); ?>">Beranda</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('user_ViewCourse')); ?>">Jadwal</a>
                        </li>
                    </ul>
    ...
    <?php elseif(session('submitCourse')): ?>
        <script>
            Swal.fire({
                title: "Success!",
                text: "<?php echo e(session('submitCourse')); ?>",
                icon: "success",
            });
        </script>
    <?php endif; ?>
...
<?php /**PATH D:\laragon\www\penjadwalan\resources\views/layouts/client.blade.php ENDPATH**/ ?>